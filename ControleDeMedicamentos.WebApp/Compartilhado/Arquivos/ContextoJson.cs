...
public class ContextoJson
{
    ...
    public ContextoJson CarregarDadosPredefinidos()
    {
        ...
        [
            new Paciente("Ana Oliveira", "(48) 99201-2001", "100000000000001", "10000000001") { Id = 1 },
            new Paciente("Bruno Santos", "(48) 99202-2002", "100000000000002", "10000000002") { Id = 2 },
            ...
            new Paciente("Elisa Martins", "(48) 99205-2005", "100000000000005", "10000000005") { Id = 5 }
        ];
